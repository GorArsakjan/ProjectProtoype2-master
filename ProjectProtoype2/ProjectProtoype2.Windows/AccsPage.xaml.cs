...
namespace ProjectProtoype2
{
    /// <summary>
    /// A page that displays a group title, a list of items within the group, and details for
    /// the currently selected item.
    /// </summary>
    public sealed partial class AccsPage : Page
    {
        ...
        public AccsPage()
        {
            ...
            this.navigationHelper.GoBackCommand = new ProjectProtoype2.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
